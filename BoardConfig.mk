...
BOARD_KERNEL_CMDLINE := androidboot.hardware=bacon androidboot.bootdevice=msm_sdcc.1 ehci-hcd.park=3 androidboot.bootdevice=msm_sdcc.1 androidboot.selinux=permissive
